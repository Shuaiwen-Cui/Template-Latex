...
% \tnotemark[1,2] % uncomment this if you want to resume the title footnotes
...
Text of section-1 \cite{Vehlowetal2013}.
...
Text of section-3 \cite{Fortunato2010}.
...
\bibliographystyle{elsarticle-num} % use numbered style for references, following the order of appearance in the text
